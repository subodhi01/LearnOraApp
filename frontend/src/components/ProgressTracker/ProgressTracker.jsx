...
//           topic.currentProgress > 0 && topic.currentProgress < topic.percentage
//         );
...
//     return Math.min(totalWeightedProgress, topic.percentage).toFixed(1);
//   };
...
//     const totalWeightedProgress = topics.reduce((sum, topic) => {
//       const topicProgress = parseFloat(calculateTopicProgress(topic.topicId, template));
//       const topicPercentage = topic.percentage || 0;
//       // Scale topic progress to its contribution to the total percentage
//       return sum + (topicProgress / topic.percentage) * topicPercentage;
//     }, 0);

//     return totalWeightedProgress.toFixed(1); // Sum of weighted topic progress
//   };
...
//         const topicProgress = parseFloat(calculateTopicProgress(topic.topicId, selectedTemplate));
//         return {
//           ...topic,
...
//                           style={{ 
//                             width: `${(topicProgress / topic.percentage) * 100}%`,
